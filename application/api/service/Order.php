...
class Order
{
    ...
    private function getProductsByOrder($oProducts)
    {
        ...
        // 为了避免循环查询数据库
        $products = Product::all($oPIDs)  // 根据订单里面商品id号，查询真实商品信息
    ...
    private function snapOrder()
    {
        ...
        $snap = [
            ...
            'totalCount' => 0,
            'pStatus' => [],
            'snapAddress' => json_encode($this->getUserAddress()),  // 最好用mongodb做存储
    ...
    private function createOrderByTrans($snap)
    {
        ...
        try {
            ...
            foreach ($this->oProducts as &$p) {
                $p['order_id'] = $orderID;      // 对数组中属性做修改操作
            }
            // 保存商品关联关系   order_id对应 order表中id
            $orderProduct = new OrderProduct();       // 某一类商品
